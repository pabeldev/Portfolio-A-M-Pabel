...
export default function CleanHero() {
  return (
    <section className="relative pt-24 pb-16 px-4 md:px-8 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10 relative">
        ...
        <div className="lg:col-span-5 flex flex-col items-center">
          ...
          <div className="relative group w-full max-w-sm">
            ...
            <div className="relative rounded-3xl bg-slate-950 border border-cyan-500/30 overflow-hidden shadow-2xl p-2.5">
              ...
              {/* Clean Overlay Badge */}
              <div className="absolute bottom-5 left-5 right-5 p-3.5 rounded-xl bg-slate-950/85 border border-slate-800 backdrop-blur-md flex items-center justify-between">
                <div>
          ...
          {/* 5 Avatar & 4.5 Star Rating Badge (Placed directly under Pabel's photo!) */}
          <AvatarRatingBadge />
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight font-['Creato_Display',sans-serif]">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <a
              href="#works"
              className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-slate-950 font-bold text-sm tracking-wide shadow-[0_0_20px_rgba(0,243,255,0.3)] hover:shadow-[0_0_30px_rgba(0,243,255,0.5)] transition-all flex items-center gap-2 group"
            >
          ...
          {/* Premiere Pro Live Video Timeline Animation Widget (Placed where stats used to be!) */}
