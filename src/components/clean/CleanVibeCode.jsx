...
export default function CleanVibeCode() {
  ...
  return (
    <section id="vibe-code" className="py-20 px-4 md:px-8 max-w-7xl mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {vibeCodedWebsites.map((site) => (
          ...
          >
            ...
            {/* Header: Displays thumbnail if present, otherwise clean cyber address box */}
