...
export const graphicDesignProjects = [
  ...
  },
  {
    ...
    behanceUrl: "https://www.behance.net/gallery/246488915/reThink",
    description: "Occasional poster series and digital visual assets for academic milestones.",
    tags: ["Poster Series", "Visual Design", "Branding"],
    client: "reThink.ac",
    year: "2026"
  }
];
...
export const vibeCodedWebsites = vibeCodingWebsites;

export const clientLogos = [
  { id: "c-1", name: "reThink.ac", logoUrl: "https://rethink.ac/logo.png" },
  { id: "c-2", name: "Campus to Country", logoUrl: "https://campustocountry.org/logo.png" },
  { id: "c-3", name: "FramEmpire Studio", logoUrl: "/assets/A-M-Pabel-Logo.webp" }
];
